...
// Модель: Haiku 4.5 — самая дешёвая ($1/$5 за 1M токенов). Для простой
// классификации 5 ответов по готовым зонам потерь её хватает с запасом;
// одна диагностика стоит ~0.2 цента. Если нужен более «живой» текст —
// можно вернуть claude-sonnet-4-6 (втрое дороже, но копирайт чуть богаче).
